                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="telephone" type="phone" class="form-control" name="telephone" value="{{ old('telephone') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('telephone2') ? ' has-error' : '' }}">
                            <label for="telephone2" class="col-md-4 control-label">Telephone 2</label>

                            <div class="col-md-6">
                                <input id="telephone2" type="phone" class="form-control" name="telephone2" value="{{ old('telephone') }}" required autofocus>
